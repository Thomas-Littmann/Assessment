...
class CanTypeC {
    public:
        ...
        /** @brief ANNAHME 
         * Für die Integration des Empfangs wird hier angenommen, dass die  Hardware CanTypeC eine Methode getMessage() bereitstellt, welche die aktuell empfangene Nachricht zurückgibt.
