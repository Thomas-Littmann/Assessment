...
class CanTypeE {
    public:
        ...
        /** @brief ANNAHME 
         * Für die Integration des Empfangs wird hier angenommen, dass die  Hardware CanTypeE eine Methode getMessage() bereitstellt, welche die aktuell empfangene Nachricht zurückgibt.
